...
/**
 * Log implementation sample
 *
 * * Interfaces are compatible with [android.util.Log].
 * * If you will setup minimum output log level for [MyLog],
 *   set string resource named "my_log_level" and call [init] on
 *   created application or activity.
 *
 * @author IceImo-P
 */
@Suppress("unused")
object MyLog : StaticLogTemplate(LogLevel.NONE) {
    /**
    ...
    fun init(context: Context) {
        super.init(context, R.string.my_log_level)
    }
